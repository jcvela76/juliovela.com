...
- Next slice after validation: implement public blog rendering and MDX routing for approved/published content only, still without automation or auto-publishing.
